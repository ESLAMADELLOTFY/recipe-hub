          ...
          <div className="tab-className text-center">
            ...
            >
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'all' ? 'active' : ''}`}
              ...
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'starter' ? 'active' : ''}`}
              ...
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'maincourse' ? 'active' : ''}`}
              ...
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'drinks' ? 'active' : ''}`}
              ...
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'offers' ? 'active' : ''}`}
              ...
              <li className="nav-item p-2">
                <a
                  className={`d-flex py-2 mx-2 border border-primary bg-white rounded-pill ${activeTab === 'ourspecials' ? 'active' : ''}`}
